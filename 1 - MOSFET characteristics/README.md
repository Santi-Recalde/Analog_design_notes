...
- Inversión fuerte (encendido)
    ...
    - Saturación
        ...
        <br>
        $I_D=\frac{1}{2}{\mu}_ n C_{ox} \frac{W}{L}(V_{GS}-V_{TH})^2$ <br>
        <br>
        ...
        <br>
        $I_D=\frac{1}{2}{\mu}_ n C_{ox} \frac{W}{L}(V_{GS}-V_{TH})^2 (1+\lambda V_{DS})$ <br>
        <br>
        ...
        <br>
        $g_m={\mu}_ n C_{ox} \frac{W}{L}(V_{GS}-V_{TH})(1+\lambda V_{DS})$ <br>
    <br>
...
| -------------- | ----------------------------------------------------- | ------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------- |
| $g_m$          | alto: $g_m = \frac{I_D}{\zeta V_T}$    | bajo                            | crece con $V_{DS}$: $g_m = {\mu}_ n C_{ox} \frac{W}{L}V_{DS}$                         | depende de $V_{GS} $: $g_m = {\mu}_ n C_{ox} \frac{W}{L}(V_{GS}-V_{TH})$                                               |
